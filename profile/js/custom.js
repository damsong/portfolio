$(document).ready(function(){
	...
	$("section").on("mousemove",function(e){      
	   ...
	   //프로그램에서 나눗셈을 쓴다는 것은 몫을 줄이는 것과 같음. (값을 크게 줄 수록 애니메이션이 적게 움직임)
	...
	$("#menu li").on("click",function(e){
	 ...
	 $(window).on("scroll",function(){   //메뉴 활성화 시키는 부분
	   ...
	   */
	   ...
	   $("section").on("mousewheel",function(event,delta){  
		  ...
		  var cnt = $("section").size()-1; //마지막 index 번호  
